...
use crate::keyboard::{self, KeyCode, Modifiers};
...
impl ScrollModeState {
    ...
    pub fn process_key(
        ...
        match keycode {
            ...
            // / - open find (Cmd+F)
            KeyCode::Slash if !modifiers.shift => {
